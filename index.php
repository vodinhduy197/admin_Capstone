            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">                       
                        ...
                        <p class="text-light">Số giao dịch thành công</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">                       
                        ...
                        <p class="text-light">Lượng thành viên đăng kí</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">                        
                        ...
                        <p class="text-light">Công ty đối tác</p>
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text">Lượt truy cập</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text">Thành viên truy cập</div>
            ...
            <div class="col-xl-6">
                <div class="card" >
                    ...
                    <div class="Vector-map-js">
                        <div id="vmap" class="vmap" style="height: 431px;"></div>
                    </div>
                </div>
                <!-- /# card -->
            </div>
