            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">Công ty đối tác</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Công ty đối tác</strong>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    <th>Tên công ty</th>
                                    <th>Doanh thu đầu tháng</th>
                                    <th>Doanh thu cuối tháng</th>
                                    <th>Ngày có doanh thu cao nhất</th>
                                    <th>Doanh thu trung bình</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
