...
<?php
require_once $_SERVER['DOCUMENT_ROOT'].'/admin/management/user/cargo-owner/insert.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/admin/management/user/cargo-owner/edit.php';
